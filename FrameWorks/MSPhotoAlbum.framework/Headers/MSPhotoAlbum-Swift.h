...
SWIFT_MODULE_NAMESPACE_PUSH("MSPhotoAlbum")
@class NSBundle;
@class NSCoder;

SWIFT_CLASS("_TtC12MSPhotoAlbum18MSPhotosController")
@interface MSPhotosController : UIViewController
- (void)viewDidLoad;
...
@interface MSPhotosController (SWIFT_EXTENSION(MSPhotoAlbum)) <UIPageViewControllerDataSource, UIPageViewControllerDelegate>
...
@interface MSPhotosController (SWIFT_EXTENSION(MSPhotoAlbum))
