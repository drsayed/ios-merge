...
open class ADCountryPicker: UITableViewController {
    ...
    fileprivate var sections: [Section] {
        ...
        var countryCode = "AE"
        print("Locale country code : \(countryCode), Default : \(defaultCountryCode)")
        ...
        print("Country name : \(displayName)")
        country.section = 0
    ...
    open var searchBarBackgroundColor = UIColor(red: 35/255, green: 107/255, blue: 41/255, alpha: 1.0)
