...
extension Image {
  ...
  public func resolve(completion: @escaping (UIImage?) -> Void) {
    ...
    //Company Admin view image separate function
    public func compImage(completion: @escaping (UIImage?) -> Void) {
      let options = PHImageRequestOptions()
      options.isNetworkAccessAllowed = true
      options.deliveryMode = .highQualityFormat
    ...
    //Commodity Admin view image separate function
    public func commodImage(completion: @escaping (UIImage?) -> Void) {
      let options = PHImageRequestOptions()
      options.isNetworkAccessAllowed = true
      options.deliveryMode = .highQualityFormat
