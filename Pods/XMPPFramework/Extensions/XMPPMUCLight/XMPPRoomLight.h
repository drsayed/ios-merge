...
//Group Message
- (void)sendMessageWithBody:(nonnull NSString *)messageBody uColor:(nonnull NSString *)color uName:(nonnull NSString *)name userId:(nonnull NSString *)from uimage:(nonnull NSString *)image urank:(nonnull NSString *)rank;
