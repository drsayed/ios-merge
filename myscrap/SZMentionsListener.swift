...
public class SZMentionsListener: NSObject {
    ...
    public init(
        ...
        #if swift(>=4.0)
//            defaultAttributes
        mentionTextAttributes =  [SZAttribute(attributeName: NSAttributedString.Key(rawValue: NSAttributedString.Key.foregroundColor.rawValue),attributeValue:UIColor.GREEN_PRIMARY),SZAttribute(attributeName: NSAttributedString.Key(rawValue: NSAttributedString.Key.font.rawValue),attributeValue:  UIFont.systemFont(ofSize: 17)     )]
//            defaultAttributes ??
           
        defaultTextAttributes = [SZAttribute(attributeName: NSAttributedString.Key(rawValue: NSAttributedString.Key.foregroundColor.rawValue),attributeValue:UIColor.BLACK_ALPHA),SZAttribute(attributeName: NSAttributedString.Key(rawValue: NSAttributedString.Key.font.rawValue),attributeValue:  UIFont.systemFont(ofSize: 17)     )]
...
extension SZMentionsListener: UITextViewDelegate {
    ...
    public func textViewDidChange(_ textView: UITextView) {
        ...
        mentionsManager.textviewsCondition()
