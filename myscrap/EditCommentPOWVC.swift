...
class EditCommentPOWVC: UIViewController {
    ...
    typealias closure = (CommentPOWItem) -> ()
    
    var commentClosure: closure?
    
    var item : CommentPOWItem?
    ...
    static func storyBoardInstance() -> EditCommentPOWVC? {
        return UIStoryboard.Comment.instantiateViewController(withIdentifier: EditCommentPOWVC.id) as? EditCommentPOWVC
    }
