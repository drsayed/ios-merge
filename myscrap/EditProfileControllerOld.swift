...
class EditProfileControllerOld: BaseRevealVC,UIGestureRecognizerDelegate { //BaseVC
    ...
    override func viewDidLoad() {
        ...
        codeTextField.editProfileSetBottomBorderDisabled()
        //codeTextField.parentViewController = self
        codeTextField.placeholder = ""
        codeTextField.flagButton.setSize(width: 45, height: 40)
        ...
        subCodeTextField.flagButton.setSize(width: 45, height: 40)
...
extension EditProfileControllerOld{
...
extension EditProfileControllerOld: UITableViewDataSource, UITableViewDelegate{
