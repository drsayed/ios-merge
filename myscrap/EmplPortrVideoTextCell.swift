...
extension EmplPortrVideoTextCell : UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout
{
...
//        }
        ...
        delegateVideoChange?.PortraitTextVideoChanged()
