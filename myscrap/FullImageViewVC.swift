...
class FullImageViewVC: UIViewController {
    ...
    private lazy var collectionView: UICollectionView = { [unowned self] in
        ...
        cv.register(FullImageAlbumCell.self)
        return cv
    }()
    
    
    convenience init(index: Int,dataSource: [String]){
        self.init()
...
extension FullImageViewVC : UICollectionViewDelegate{ }
extension FullImageViewVC : UICollectionViewDataSource{
...
//    }
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell : FullImageAlbumCell = collectionView.dequeReusableCell(forIndexPath: indexPath)
        cell.activityIndicator.stopAnimating()
        cell.imageView.sd_setImage(with: URL(string: dataSource[indexPath.item]), completed: nil)
        cell.imageView.contentMode = .scaleAspectFit
        cell.activityIndicator.stopAnimating()
      //  cell.imageView.sd_setImage(with: <#T##URL?#>, completed: <#T##SDExternalCompletionBlock?##SDExternalCompletionBlock?##(UIImage?, Error?, SDImageCacheType, URL?) -> Void#>)(imageURL: dataSource[indexPath.item])
