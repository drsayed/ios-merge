//
//  UserFeedLandScapVideoCell.swift
//  myscrap
//
...
extension UserFeedLandScapVideoCell : UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout
{
...
//        }
       // NotificationCenter.default.post(name: Notification.Name("VideoPlayedChanged"), object: nil)
        delegateVideoChange?.UserFeedLandScapVideoChanged()
