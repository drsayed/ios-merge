...
public class PhotoLibraryViewController: UIViewController {
    ...
    public override func viewWillAppear(_ animated: Bool) {
        ...
        self.navigationController?.navigationBar.barTintColor = UIColor.GREEN_PRIMARY
        self.navigationController?.navigationBar.tintColor = UIColor.white
        self.navigationController!.navigationBar.titleTextAttributes = [ NSAttributedString.Key.foregroundColor : UIColor.WHITE_ALPHA , NSAttributedString.Key.font : Fonts.NAVIGATION_FONT!]
        navigationController?.navigationItem.title = "Select Photo"
    }
