...
import AVFoundation
import Photos
protocol VideoTextPlayerDelegate : class {
    func playTextVedio(url: String)
}
class FeedDetailVideoTextCell: BaseCell {
     ...
     @IBOutlet weak var editButton: UIButton!
       ...
       @IBOutlet weak var designationLbl: DesignationLabel!
           var muteVideo = true
    weak var videoPlayerDelegate : VideoTextPlayerDelegate?
...
//           videoView.addGestureRecognizer(videoTap)
    ...
    @objc func pausedVideoDidEnd(notification: Notification) {
       ...
       func refreshTable()  {
                ...
                self.videosCollection.register(VideoDetailCell.Nib, forCellWithReuseIdentifier: VideoDetailCell.identifier)
...
//           }
    ...
    func removePeriodicTimeObserver() {
       ...
       func getThumbnailImageFromVideoUrl(url: URL, completion: @escaping ((_ image: UIImage?)->Void)) {
           DispatchQueue.global().async { //1
               ...
               avAssetImageGenerator.maximumSize = CGSize(width: self.width, height: 400)
    ...
    @objc  func playButtonPresssed(sender: UIButton!){
       //...
        ...
        videoPlayerDelegate?.playTextVedio(url: objVide.video)
    }
...
extension FeedDetailVideoTextCell : UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout
{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: VideoDetailCell.identifier, for: indexPath) as? VideoDetailCell else { return UICollectionViewCell()}
        ...
        cell.playBtn.addTarget(self, action:#selector(FeedDetailVideoTextCell.playButtonPresssed), for: .touchUpInside)
      //  cell.playBtnAction
...
//                let videoCell = cell as! VideoDetailCell
