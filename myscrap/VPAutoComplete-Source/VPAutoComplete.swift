...
class VPAutoComplete: UIView {
    ...
    public func show(completionHandler: @escaping CompletionHandler){
        ...
        if (textFieldView != nil) {
            self.tableView?.frame = CGRect(x: 0, y: 0, width:  onView?.frame.width ??  textFieldView.frame.width + extraWidth     , height: 150)
            self.frame = CGRect(x: onTextField.frame.minX, y: textFieldView.frame.maxY, width: onView?.frame.width ?? textFieldView.frame.width + extraWidth, height: 150)
        }else{
            self.tableView?.frame = CGRect(x: 0, y: 0, width:onView?.frame.width ??  onTextField.frame.width + extraWidth, height: 150)
            self.frame = CGRect(x: onTextField.frame.minX, y: onTextField.frame.maxY, width: onView?.frame.width ?? onTextField.frame.width + extraWidth, height: 150)
        }
