...
class FeedDetailVideoCell: BaseCell {
...
//           videoView.addGestureRecognizer(videoTap)
    ...
    @objc  func playButtonPresssed(sender: UIButton!){
       //...
        ...
        videoPlayerDelegate?.playVedio(url: objVide.video)
    }
...
extension FeedDetailVideoCell : UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout
{
