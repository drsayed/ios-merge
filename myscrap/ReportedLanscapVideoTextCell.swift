//
//  ReportedLanscapVideoTextCell.swift
//  myscrap
//
...
protocol LandscapVideoTextsOnReportPlayerDelegate : class {
...
class ReportedLanscapVideoTextCell: BaseCell {
 ...
 @IBOutlet weak var videosCollection: UICollectionView!
    weak var videoPlayerDelegate : LandscapVideoTextsOnReportPlayerDelegate?
 ...
 var addCommentAction : (() -> Void)? = nil
    ...
    @objc  func playButtonPresssed(sender: UIButton!){
       //...
        ...
        videoPlayerDelegate?.playLandscapReportedTextVedio(url: objVide.video)
    }
...
extension ReportedLanscapVideoTextCell : UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout
{
...
return CGSize(width:screenWidth, height: 420)
    ...
    let tintUnmuteImg = unMuteImg.withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
        ...
        videoPlayerDelegate?.LandscapTextVideoChanged()
...
extension ReportedLanscapVideoTextCell : LandScapFullScreenDelegate
{
    func LandScapVideoFullScreenPressed(player: AVPlayer) {
       videoPlayerDelegate?.ReportedLandscapVideoTextFullscreenPressed(player: player)
    }
