...
import UIKit
protocol SelectCompanyDelegate: class {
  func selectedCompany(company: CompanyItem)
}
class SelectCompanyVC: UIViewController,UITableViewDelegate,UITableViewDataSource, UISearchBarDelegate {
    ...
    weak var delegate : SelectCompanyDelegate?
    ...
    @IBAction func backButtonPrressed(_ sender: Any) {
    ...
    fileprivate func handleRefresh(){
        ...
        getCompanyValues(pageLoad: 0, searchText: searchText, countryFilter: "224", completion: {_ in })
    }
...
extension SelectCompanyVC: CompanyFilterAlertDelegate{
...
extension SelectCompanyVC: UISearchResultsUpdating{
