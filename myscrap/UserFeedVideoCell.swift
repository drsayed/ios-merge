...
extension UserFeedVideoCell : UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout
{
...
//        }
    //    NotificationCenter.default.post(name: Notification.Name("VideoPlayedChanged"), object: nil)
        delegateVideoChange?.UserFeedVideoChanged()
