...
class EmplLandsVideoTextCell: BaseCell {
    ...
    */
    func setupVideoLayer(videoUrl: URL) {
        ...
        //thumbnailImg.isHidden = true
        //videoView.isHidden = false
        //Commenting here to stop video repeated playing
...
extension EmplLandsVideoTextCell : UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout
{
