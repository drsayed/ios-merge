...
import AVKit
class UserProfileVC: BaseVC, FriendControllerDelegate {
...
extension UserProfileVC:UICollectionViewDelegateFlowLayout{
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        if indexPath.section == 0 {
            ...
            return CGSize(width: view.frame.width, height: 278)
            }
            return CGSize(width: view.frame.width, height: 278 + 40)
        } else {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, referenceSizeForHeaderInSection section: Int) -> CGSize {
        if section == 1 && isInitiallyLoaded == true && dataSourceV2.count == 0 {
    ...
    static func storyBoardInstance() -> UserProfileVC? {
        let st = UIStoryboard(name: StoryBoard.PROFILE, bundle: nil)
        return st.instantiateViewController(withIdentifier: UserProfileVC.id) as? UserProfileVC
    }
}

extension UserProfileVC: ProfileServiceDelegate{
...
extension UserProfileVC : MyProfileCellDelegate {
    func DidPressAboutBtn(cell: BaseCell) {
        goToAboutVC()
    }
