...
open class Floaty: UIView {
    ...
    */
    @IBInspectable
    @objc open var title: UILabel = UILabel()
    ...
    Button Title.
    */
    fileprivate var buttonTitle: UILabel = UILabel()
...
extension Floaty {
    ...
    func setAccessibilityView() {
        ...
        accessibilityView.accessibilityTraits = UIAccessibilityTraits(rawValue: accessibilityTraits.rawValue | UIAccessibilityTraits.button.rawValue)
    }
