...
class ReportedVideoCell: BaseCell {
 ...
 @IBOutlet weak var videosCollection: UICollectionView!
    weak var videoPlayerDelegate : VideoOnReportedPlayerDelegate?
...
//    }
    ...
    @objc  func playButtonPresssed(sender: UIButton!){
       //...
        ...
        videoPlayerDelegate?.playReportedVedio(url: objVide.video)
    }
}
extension ReportedVideoCell : UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout
{
