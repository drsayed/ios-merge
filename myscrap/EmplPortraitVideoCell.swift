...
extension EmplPortraitVideoCell : UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout
{
    func collectionView(_ collectionView: UICollectionView, didEndDisplaying cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
           ...
           if let videoCell = cell as? PortraitVideoCell {
            ...
            videoCell.pause()
            //videoCell.playerView.pla.replaceCurrentItem(with: nil)
...
//        }
    ...
    //        }
        ...
        delegateVideoChange?.PortraitVideoChanged()
...
//            if let videoCell = self.videosCollection.cellForItem(at: visibleCellIndex) as? PortraitVideoCell {
//
//                        videoCell.playerView.isMuted = true
//                        if  videoCell.playerView.isMuted {
//                            videoCell.muteBtn.setImage(tintMuteImg, for: .normal)
